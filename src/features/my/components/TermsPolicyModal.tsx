...
const TermsPolicyModal = ({ open, onOpenChange }: TermsPolicyModalProps) => {
  return (
    <RadixDialog.Root modal open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        <RadixDialog.Content className="fixed left-1/2 inset-0 -translate-x-1/2 w-full max-w-md h-screen overflow-auto bg-[#161820] px-5 text-[#AAAAAA]">
          <Header title="약관 및 정책" onClick={() => onOpenChange(false)} />
          <section id="terms">
            <h2 className="text-2xl py-7">📄 이용약관</h2>

            <h3 className="text-lg">제1조 (목적)</h3>
            <p className="pb-7">
            ...
            <h3>제2조 (정의)</h3>
            <ul className="pb-7 list-disc pl-4">
              <li>
          ...
          <div className="pt-7 pb-14">⸻</div>
          <section id="privacy">
            <h2 className="text-2xl pb-7">🔐 개인정보 처리방침</h2>
            ...
            <h3>제2조 (수집 방법)</h3>
            <p className="pb-7">
              회원가입, 서비스 이용, 이벤트 응모 시 이용자가 직접 입력
            </p>

            <h3>제3조 (수집 및 이용 목적)</h3>
            <ol className="pb-7 pl-3">
              <li>1. 서비스 제공·이행(회원 관리, 결제 처리)</li>
              <li>2. 고객 문의·불만 처리</li>
              <li>3. 마케팅·광고 활용(이용자 동의 시)</li>
            </ol>
            ...
            <h3>제9조 (책임 및 안전조치)</h3>
            <p className="pb-7">
              SSL 암호화·접근 통제 등 기술적·관리적 보호조치를 수행합니다.
            </p>

            <h3>제10조 (정책 변경)</h3>
            <p className="pb-7">
              방침 변경 시 앱 내 공지 및 이메일·푸시 알림으로 고지합니다.
            </p>
          </section>
        </RadixDialog.Content>
      </RadixDialog.Portal>
